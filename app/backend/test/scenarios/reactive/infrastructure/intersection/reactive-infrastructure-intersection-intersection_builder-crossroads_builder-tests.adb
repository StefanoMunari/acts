...
package body Reactive.Infrastructure.Intersection.Intersection_Builder.Crossroads_Builder.Tests is
   ...
   procedure Set_Up (T: in out Crossroads_Builder_Test) is
   begin
      T.Intersection_Id := 234;
   ...
   --                  REGISTRATION
   -----------------------------------------------------
   procedure Register_Tests (T: in out Crossroads_Builder_Test) is
   begin
   ...
   function Name(T: Crossroads_Builder_Test) return AU.Message_String is
   begin
      return AU.Format ("Crossroads_Builder");
   end Name;
