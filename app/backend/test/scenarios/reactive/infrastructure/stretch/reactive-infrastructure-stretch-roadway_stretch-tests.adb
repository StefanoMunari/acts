...
package body Reactive.Infrastructure.Stretch.Roadway_Stretch.Tests is
   ...
   -----------------------------------------------------
   Street_Id : Infra_Id;
   Roadway_Stretch_Id : Infra_Id;
   Bus_Id : Natural;
   Stretch_Size : Natural;

   procedure Set_Up (T: in out Roadway_Stretch_Test) is
   begin
      Street_Id := 1;
      Roadway_Stretch_Id := 2;
      Bus_Id := 10;
      Stretch_Size := 4;
      ...
      T.Stretch
         := Stretch.Reference (
            Roadway_Stretch.Create (
               Id              => Roadway_Stretch_Id,
               Size            => Stretch_Size,
   ...
   --                  REGISTRATION
   -----------------------------------------------------
   procedure Register_Tests (T: in out Roadway_Stretch_Test) is
   begin
      Stretch.Tests.Register_Tests (Stretch.Tests.Stretch_Test (T));
   end Register_Tests;

   function Name(T: Roadway_Stretch_Test) return AU.Message_String is
   begin
      return AU.Format ("Roadway_Stretch");
   end Name;
