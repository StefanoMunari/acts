...
package Reactive.Infrastructure.Stretch.Decoration.Pedestrian_Crossing.Tests is
   package AU renames AUnit;
   package TC renames AUnit.Test_Cases;

   type Pedestrian_Crossing_Test is new Zebra_Crossing.Tests.Zebra_Crossing_Test
      with null record;

   overriding
   procedure Set_Up (T : in out Pedestrian_Crossing_Test);
   ...
   procedure Register_Tests (T : in out Pedestrian_Crossing_Test);
   overriding
   function Name (T : in Pedestrian_Crossing_Test)
