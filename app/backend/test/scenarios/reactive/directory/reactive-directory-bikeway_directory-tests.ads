...
package Reactive.Directory.Bikeway_Directory.Tests is
   package AU renames AUnit;
   package TC renames AUnit.Test_Cases;

   type Bikeway_Directory_Test is new
      TC.Test_Case with null record;

   overriding procedure Set_Up (T: in out Bikeway_Directory_Test);
   overriding procedure Tear_Down (T: in out Bikeway_Directory_Test);

   procedure Register_Tests (T: in out Bikeway_Directory_Test);
   overriding function Name (T: in Bikeway_Directory_Test)
