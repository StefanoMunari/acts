...
package Reactive.Directory.Roadway_Directory.Tests is
   package AU renames AUnit;
   package TC renames AUnit.Test_Cases;

   type Roadway_Directory_Test is new
      TC.Test_Case with null record;

   overriding procedure Set_Up (T: in out Roadway_Directory_Test);
   overriding procedure Tear_Down (T: in out Roadway_Directory_Test);

   procedure Register_Tests (T: in out Roadway_Directory_Test);
   overriding function Name (T: in Roadway_Directory_Test)
