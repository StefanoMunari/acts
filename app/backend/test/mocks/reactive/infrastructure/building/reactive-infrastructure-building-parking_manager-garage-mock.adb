...
package body Reactive.Infrastructure.Building.Parking_Manager.Garage.Mock is

   function Create return Parking_Manager.Reference
   is (new Parking_Manager.Garage.Mock.Object);

   procedure Park_Vehicle (This         : in out Parking_Manager.Garage.Mock.Object;
         ...
         Raise_Missing_Return_Value_For_Mocked_Procedure_Exception
           (Parameter_Name => "Returned values",
            ...
            Package_Name => "Reactive.Infrastructure.Stretch"
                            & ".Decoration.Parking_Manager.Garage.Mock");
      end if;
   ...
   function Leave_Parking (This         : in out Parking_Manager.Garage.Mock.Object;
   ...
   return Boolean is
   begin
      if not This.Return_Values.Is_A_Driver_Existence then
         Raise_Missing_Return_Value_For_Mocked_Procedure_Exception (
            Parameter_Name => "Returned values",
            Procedure_Name => "Is_A_Driver",
            Package_Name   => "Reactive.Infrastructure.Building"
                            & ".Parking_Manager.Garage.Mock");
      end if;

      return This.Return_Values.Is_A_Driver;
   end Is_A_Driver;
   ...
   overriding
   procedure Set_Host_Id (This    : in out Garage.Mock.Object;
   ...
   function Dump (This : Parking_Manager.Garage.Mock.Object) return G_JSON.JSON_Value
   is
   begin
   ...
   begin
      This.Return_Values.Is_A_Driver := Return_Value;
      This.Return_Values.Is_A_Driver_Existence := True;
   end Set_Values_For_Is_A_Driver;
   ...
   function Get_Park_Vehicle_Called (
      This   : in out Parking_Manager.Garage.Mock.Object) return Boolean is
   begin
