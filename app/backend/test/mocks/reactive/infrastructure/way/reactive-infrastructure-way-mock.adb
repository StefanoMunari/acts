...
package body Reactive.Infrastructure.Way.Mock is

   function Create return Way.Mock.Reference
   is (new Way.Mock.Object);
      ...
      if not This.Return_Values.Add_Lane_Existence then
         Raise_Missing_Return_Value_For_Mocked_Procedure_Exception
           (Parameter_Name => "Added",
            ...
            Package_Name   => "Reactive.Infrastructure.Way.Mock");
      end if;

      Added := This.Return_Values.Add_Lane;
   end Add_Lane;

   procedure Find_Lane_By_Direction (This             : in Way.Mock.Object;
   ...
   function Get_Id (This : in Way.Mock.Object) return Infra_Id is
   begin
